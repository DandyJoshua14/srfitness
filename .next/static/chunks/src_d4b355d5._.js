...
function VoiceAgentClient({ initialQuery, onConversationEnd }) {
    ...
    const keepAliveInterval = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const isSupported = "object" !== 'undefined' && !!(window.SpeechRecognition || window.webkitSpeechRecognition) && !!window.speechSynthesis;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleAiResponse = async (query)=>{
        ...
        setError(null);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$050538__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["generateVoiceResponse"])({
                query
            });
...
_s(VoiceAgentClient, "wGJHAncBGNbtwQSGtd7PPxdNYoc=", false, function() {
    return [
...
//# sourceMappingURL=src_d4b355d5._.js.map