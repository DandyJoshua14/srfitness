...
function Header() {
    ...
    const navLinkClasses = (isActive)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-ring", isScrolled ? isActive ? "text-primary bg-primary/10 font-semibold" // Active and Scrolled
    ...
    const dropdownTriggerClasses = (isDropdownActive)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-ring flex items-center gap-1", isScrolled ? isDropdownActive ? "text-primary bg-primary/10 font-semibold" : "text-foreground/80 hover:text-primary hover:bg-muted/50" : isDropdownActive ? "text-primary font-semibold" : "text-white hover:text-primary hover:bg-white/10");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fdfca65b._.js.map