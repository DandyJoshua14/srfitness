...
"[project]/src/app/data:b5c72b [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$b5c72b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/data:b5c72b [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function VotePage() {
    ...
    const handleNominationSubmit = (values)=>{
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$b5c72b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["sendNominationEmail"])(values);
            if (result.success) {
                toast({
...
//# sourceMappingURL=src_fbdb828f._.js.map