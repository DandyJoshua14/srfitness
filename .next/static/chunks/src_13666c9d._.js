...
"[project]/src/ai/flows/data:19dc62 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$19dc62__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:19dc62 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-client] (ecmascript)");
...
function VoiceAgentClient({ initialQuery, onConversationEnd }) {
    ...
    const handleAiResponse = async (query)=>{
        ...
        setError(null);
        try {
            const { response } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$19dc62__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["generateVoiceResponse"])({
                query
            });
...
function VoiceAgentDialog({ className }) {
            ...
            recognition.onstart = ({
                "VoiceAgentDialog.useEffect": ()=>{
                    ...
                    toast({
                        ...
                        description: `Say "Hey SR" to start.`
                    });
                }
            })["VoiceAgentDialog.useEffect"];
            recognition.onend = ({
    ...
    const handleToggleListening = ()=>{
        if (isListening) {
            stopListening();
            toast({
                title: "Wake Word Listening Disabled"
            });
        } else {
            startListening();
        }
...
_s(VoiceAgentDialog, "e+ufRGxx/OyMbo8AKPmeesk4dD0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
//# sourceMappingURL=src_13666c9d._.js.map