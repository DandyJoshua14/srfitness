...
export default function BurnOffBootcampPage() {
  ...
  const allPhotos = [
    { src: '/re2.jpeg', alt: 'Bootcamp', dataAiHint: 'group fitness pushups', objectPosition: 'center 10%' },
    { src: '/re1.jpeg', alt: 'Bootcamp', dataAiHint: 'fitness trainer motivation', objectPosition: 'center 5%' },
    { src: '/re3.jpeg', alt: 'Bootcamp', dataAiHint: 'bootcamp fitness drill', objectPosition: 'center 10%' },
